<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="ListarMeusOrcamentos.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.ListarMeusOrcamentos" %>
            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <telerik:RadGrid Culture="pt-PT" runat="server" ID="listagemOrcamentos" Skin="MetroTouch" OnNeedDataSource="listagemOrcamentos_NeedDataSource" OnItemDataBound="listagemOrcamentos_ItemDataBound" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True" AllowPaging="True">
