...
{
    public partial class ListagemGeralOrdensReparacao : Telerik.Web.UI.RadAjaxPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //(Page.Master.FindControl("orlistgeral") as HtmlControl).Attributes.Add("class", "active");
                ...
                if (User.Identity.IsAuthenticated == true)
                {
                    ...
                    if (regra == "Administrador" || regra == "SuperAdmin")
                    {
                        ...
                        var carregaOrs = from ordem in DC.Ordem_Reparacaos
                                         ...
                                         where ordem.ID_ESTADO == 1 || ordem.ID_ESTADO == 2 || ordem.ID_ESTADO == 3 || ordem.ID_ESTADO == 4 || ordem.ID_ESTADO == 5
        ...
        protected void listagemgeralors_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                ...
                hLink.Target = "_blank";
                hLink.NavigateUrl = "ImprimeORCliente.aspx?ID=" + val1;
            }
