...
{
    public partial class ListarMarca : Telerik.Web.UI.RadAjaxPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            (Page.Master.FindControl("marcasedit") as HtmlControl).Attributes.Add("class", "active");
        ...
        protected void listagemmarcasregistadas_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                ...
                HyperLink hLink = (HyperLink)item["EDITARMARCA"].Controls[0];
                hLink.NavigateUrl = "EditarMarca.aspx?ID=" + val1;
            }
        }
    }
}