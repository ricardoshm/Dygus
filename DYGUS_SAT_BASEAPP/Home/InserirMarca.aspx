<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="InserirMarca.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.InserirMarca" MaintainScrollPositionOnPostback="true" %>
                        ...
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                ...
                                <div class="form-actions">
                                    <asp:Button runat="server" ID="btnGravarMarca" Text="Gravar Marca" CssClass="button button-basic-blue" OnClick="btnGravarMarca_Click" OnClientClick="return validaCampos();" />
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        ...
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <telerik:RadGrid Culture="pt-PT" runat="server" ID="listagemmarcas" Skin="MetroTouch" OnNeedDataSource="listagemmarcas_NeedDataSource" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True" AllowPaging="True">
                                    <GroupingSettings CaseSensitive="false" />
                                    <MasterTableView NoMasterRecordsText="Não existem marcas registadas!" NoDetailRecordsText="Não existem marcas registados!" AutoGenerateColumns="False">
