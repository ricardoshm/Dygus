<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="EditarOrdemReparacaoAdmin.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.EditarOrdemReparacaoAdmin" %>
            ...
            <div class="span6" id="divvaloresmanuais" runat="server">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label" for="normal">Valor Custo</label>
                                <div class="controls controls-row">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="normal">Valor Reparação</label>
                                <div class="controls controls-row">
                    ...
                    <div class="widget-content">
                        <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <telerik:RadComboBox ID="ddlestado" Width="285px" runat="server" CssClass="span12" Skin="MetroTouch">
                                    </telerik:RadComboBox>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="widget-content">
                        <div class="form-horizontal">
                            ...
                            <div class="form-actions">
                                ...
                                <asp:Button runat="server" ID="btnConsultarOrcamento" Text="Consultar Orçamento" CssClass="btn btn-info btn-large" OnClick="btnConsultarOrcamento_Click" />
                            </div>
