<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="EliminarEstados.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.EliminarEstados" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="content">
        <div class="page-header">
            <div class="pull-left">
                <h4><i class="icon-file-alt"></i>Estados de Ordem de Reparação | Eliminar</h4>
            </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <telerik:RadGrid Culture="pt-PT" runat="server" ID="listagemestados" OnItemCommand="listagemestados_ItemCommand" Skin="MetroTouch" OnNeedDataSource="listagemestados_NeedDataSource" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True" AllowPaging="True">
                                    ...
                                    <MasterTableView NoMasterRecordsText="Não existem estados registados!" NoDetailRecordsText="Não existem estados registados!" AutoGenerateColumns="False">
                                        <Columns>
                                            <telerik:GridButtonColumn Text="Eliminar Estado" CommandName="Delete" ButtonType="ImageButton"
                                                ConfirmText="Tem a certeza que deseja eliminar este estado?" ConfirmDialogType="RadWindow"
