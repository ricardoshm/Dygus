<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="GerirMeuORC.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.GerirMeuORC" %>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="control-group">
                                            <div class="controls-row">
                                                <br />
                                                <asp:Button runat="server" ID="btnAceitar" Text="Aprovar Orçamento" CssClass="btn btn-success span3" OnClick="btnAceitar_Click" />
                                                <asp:Button runat="server" ID="btnRejeitar" Text="Rejeitar Orçamento" CssClass="btn btn-danger span3" OnClick="btnRejeitar_Click" OnClientClick="Confirm()" />
                                            </div>
                                        </div>
                                        <!-- End .control-group -->
                                    </div>
