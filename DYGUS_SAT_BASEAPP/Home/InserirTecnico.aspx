<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="InserirTecnico.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.InserirTecnico" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        <div id="heading" class="page-header">
            <h1><i class="icon20 i-list-4"></i>Inserir Técnico</h1>
        </div>
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
                    ...
                    <!-- End .widget-title -->
                    <div class="widget-content">
                        <telerik:RadGrid Culture="pt-PT" runat="server" ID="listagemtecnicosregistados" Skin="MetroTouch" OnNeedDataSource="listagemtecnicosregistados_NeedDataSource" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True" AllowPaging="True">
                            ...
                            <MasterTableView NoMasterRecordsText="Não existem técnicos registados!" NoDetailRecordsText="Não existem técnicos registados!" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn AllowFiltering="true" AutoPostBackOnFilter="true" ShowFilterIcon="false" ItemStyle-Font-Bold="true" ItemStyle-ForeColor="Green" DataField="COD_TECNICO" ReadOnly="True" HeaderText="Código" SortExpression="COD_TECNICO" UniqueName="COD_TECNICO" FilterControlAltText="Filter COD_TECNICO column"></telerik:GridBoundColumn>
