<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="InserirOrcamentoCliente.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.InserirOrcamentoCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
                    <asp:Button runat="server" ID="btnRefresh" Text="Clique aqui para refazer o Orçamento (Refresh)" CssClass="btn btn-primary btn-large span12" OnClick="btnRefresh_Click" />
                </div>
                <!-- End .widget -->
            </div>
            <!-- End .span6 -->
                ...
                <div class="widget">
                    ...
                    <div class="widget-content" id="historicoCliente" runat="server">
                        <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="normal">Histórico ORC's</label>
                                <div class="controls controls-row">
                                    <telerik:RadGrid ClientSettings-Scrolling-AllowScroll="true" Culture="pt-PT" OnItemDataBound="listagemorcamentoscliente_ItemDataBound" runat="server" ID="listagemorcamentoscliente" Skin="MetroTouch" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True">
                                        <GroupingSettings CaseSensitive="false" />
                                        <ExportSettings>
                                            <Pdf PageWidth=""></Pdf>
                                        </ExportSettings>
                                        ...
                                        <MasterTableView NoMasterRecordsText="Não existem orçamentos!" NoDetailRecordsText="Não existem orçamentos!" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn ItemStyle-ForeColor="Green" ItemStyle-Font-Bold="true" AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="CODIGO" ReadOnly="True" HeaderText="Código ORC" SortExpression="CODIGO" UniqueName="CODIGO" FilterControlAltText="Filter CODIGO column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="DATA_REGISTO" ReadOnly="True" HeaderText="Data Registo ORC" SortExpression="DATA_REGISTO" UniqueName="DATA_REGISTO" DataType="System.DateTime" FilterControlAltText="Filter DATA_REGISTO column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn ItemStyle-ForeColor="Green" ItemStyle-Font-Bold="true" AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="CODIGOCLIENTE" ReadOnly="True" HeaderText="Código Cliente" SortExpression="CODIGOCLIENTE" UniqueName="CODIGOCLIENTE" FilterControlAltText="Filter CODIGOCLIENTE column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="MARCA_EQUIP_AVARIADO" ReadOnly="True" HeaderText="Marca" SortExpression="MARCA_EQUIP_AVARIADO" UniqueName="MARCA_EQUIP_AVARIADO" FilterControlAltText="Filter MARCA_EQUIP_AVARIADO column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="MODELO_EQUIP_AVARIADO" ReadOnly="True" HeaderText="Modelo" SortExpression="MODELO_EQUIP_AVARIADO" UniqueName="MODELO_EQUIP_AVARIADO" FilterControlAltText="Filter MODELO_EQUIP_AVARIADO column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="VALOR_FINAL" DataFormatString="{0:F2} &#8364;" ReadOnly="True" HeaderText="Valor OR" SortExpression="VALOR_FINAL" UniqueName="VALOR_FINAL" DataType="System.Double" FilterControlAltText="Filter VALOR_FINAL column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="DATA_CONCLUSAO" ReadOnly="True" HeaderText="Data Conclusão" SortExpression="DATA_CONCLUSAO" UniqueName="DATA_CONCLUSAO" DataType="System.DateTime" FilterControlAltText="Filter DATA_CONCLUSAO column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn ItemStyle-BackColor="LightBlue" ItemStyle-ForeColor="Green" ItemStyle-Font-Bold="true" AllowFiltering="true" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="ESTADO_OR" ReadOnly="True" HeaderText="Estado OR" SortExpression="ESTADO_OR" UniqueName="ESTADO_OR" FilterControlAltText="Filter ESTADO_OR column"></telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn Display="false" AllowFiltering="false" ShowFilterIcon="false" AutoPostBackOnFilter="true" DataField="ID" ReadOnly="True" HeaderText="iD ORC" SortExpression="ID" UniqueName="ID" DataType="System.Int32" FilterControlAltText="Filter ID column"></telerik:GridBoundColumn>
                                            </Columns>
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="widget">
                    ...
                    <!-- End .widget-title -->
                    <div class="widget-content" id="painelCliente" runat="server">
                        <div class="form-horizontal">
                            <div class="control-group">
                    ...
                    <div class="widget-content">
                        <div class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <telerik:RadTextBox Width="750" Height="200" Skin="MetroTouch" runat="server" ID="tbComentariosOrcamento" TextMode="MultiLine" placeholder="Comentários" CssClass="span12"></telerik:RadTextBox>
                                </div>
                            </div>
                        </div>
                    </div>
