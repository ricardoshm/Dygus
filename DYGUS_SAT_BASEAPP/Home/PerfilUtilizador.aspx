...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="crumb">
        <ul class="breadcrumb">
            ...
            <li><a href="#">Perfil de Utilizador</a> <span class="divider">/</span></li>
            <li class="active">Definições</li>
        </ul>
    </div>
    <div class="container-fluid">
        <div id="heading" class="page-header">
            <h1><i class="icon20 i-list-4"></i>Perfil de Utilizador</h1>
        </div>
        <div class="row-fluid">
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="focused">Nome de Utilizador</label>
                                <div class="controls controls-row">
                                    <telerik:RadTextBox Width="400" Skin="MetroTouch" runat="server" ID="tbusername" CssClass="span12" ReadOnly="true"></telerik:RadTextBox>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="password">Palavra-Passe Antiga</label>
                                <div class="controls controls-row">
                                    <telerik:RadTextBox Width="400" Skin="MetroTouch" runat="server" ID="tbpassantiga" TextMode="Password" CssClass="span12"></telerik:RadTextBox>
                                    <asp:HiddenField ID="emailuser" runat="server" Value="" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="password">Palavra-Passe Nova</label>
                                <div class="controls controls-row">
                                    <telerik:RadTextBox Width="400" Skin="MetroTouch" runat="server" ID="tbnovapass" TextMode="Password" CssClass="span12"></telerik:RadTextBox>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="password">Confirmação de Palavra-Passe</label>
                                <div class="controls controls-row">
                                    <telerik:RadTextBox Width="400" Skin="MetroTouch" runat="server" ID="tbconfirmanovapass" TextMode="Password" CssClass="span12"></telerik:RadTextBox>
                                </div>
                            </div>
