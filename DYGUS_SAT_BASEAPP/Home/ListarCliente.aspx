<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="ListarCliente.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.ListarCliente" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <telerik:RadGrid Culture="pt-PT" runat="server" ID="listagemclientesregistados" Skin="MetroTouch" OnItemDataBound="listagemclientesregistados_ItemDataBound" OnNeedDataSource="listagemclientesregistados_NeedDataSource" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True" AllowPaging="True">
                            ...
                            <MasterTableView NoMasterRecordsText="Não existem clientes registados!" NoDetailRecordsText="Não existem clientes registados!" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                  <telerik:GridHyperLinkColumn ItemStyle-CssClass="btn btn-danger btn-full tip" ItemStyle-Font-Bold="true" Text="Editar" AllowSorting="False" AllowFiltering="false" ShowFilterIcon="false" AutoPostBackOnFilter="false" UniqueName="EDITARCLIENTE" FilterControlAltText="Filter EDITARCLIENTE column"></telerik:GridHyperLinkColumn>

                                    <telerik:GridBoundColumn AllowFiltering="true" AutoPostBackOnFilter="true" ItemStyle-ForeColor="Green" ItemStyle-Font-Bold="true" ShowFilterIcon="false" DataField="CODIGO" ReadOnly="True" HeaderText="Código" SortExpression="CODIGO" UniqueName="CODIGO" FilterControlAltText="Filter CODIGO column"></telerik:GridBoundColumn>
