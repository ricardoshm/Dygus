...
{
    public partial class FecharOrdemReparacaoDetalheES : Telerik.Web.UI.RadAjaxPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //(Page.Master.FindControl("orfecho") as HtmlControl).Attributes.Add("class", "active");
        ...
        protected void carregaOR()
        {
            ...
            foreach (var item in ordemRep)
            {
                ...
                tbcodequipsubst.Text = item.Equipamentos_Substituicao.CODIGO;
            }
        ...
        protected void btnGravar_Click(object sender, EventArgs e)
        {
            ...
            foreach (var itemordem in pesquisaOR)
            {
                if (itemordem.ID_ESTADO != 6)
                {
                    ...
                    itemordem.Equipamentos_Substituicao.ID_DISPONIBILIDADE = 1;
