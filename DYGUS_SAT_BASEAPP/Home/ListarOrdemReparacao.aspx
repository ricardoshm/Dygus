<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="ListarOrdemReparacao.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.ListarOrdemReparacao" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        <div id="heading" class="page-header">
            <h1><i class="icon20 i-list-4"></i>Gerir/Editar Ordens de Reparação</h1>
        </div>
            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <telerik:RadGrid Culture="pt-PT" runat="server" ID="listagemordensreparacaoregistadas" Skin="MetroTouch" OnNeedDataSource="listagemordensreparacaoregistadas_NeedDataSource" OnItemCommand="listagemordensreparacaoregistadas_ItemCommand" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True" AllowPaging="True">
