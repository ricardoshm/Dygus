<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="ListagemOrcamentoClienteFechados.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.ListagemOrcamentoClienteFechados" %>
            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <telerik:RadGrid Culture="pt-PT" runat="server" ID="listagemgeralors" Skin="MetroTouch" OnNeedDataSource="listagemgeralors_NeedDataSource" AllowFilteringByColumn="True" CellSpacing="0" GridLines="None" AllowSorting="True" AllowPaging="True">
