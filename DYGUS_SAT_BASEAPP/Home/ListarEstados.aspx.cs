...
{
    public partial class ListarEstados : Telerik.Web.UI.RadAjaxPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //(Page.Master.FindControl("estadosedit") as HtmlControl).Attributes.Add("class", "active");
        }
        ...
        protected void listagemestados_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if (e.Item is GridDataItem)
            {
                ...
                hLink.NavigateUrl = "EditarEstados.aspx?id=" + val1;
            }
        }
    }
}