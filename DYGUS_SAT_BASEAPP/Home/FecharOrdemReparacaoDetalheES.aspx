<%@ Page Title="" Language="C#" MasterPageFile="~/Home/Home.Master" AutoEventWireup="true" CodeBehind="FecharOrdemReparacaoDetalheES.aspx.cs" Inherits="DYGUS_SAT_BASEAPP.Home.FecharOrdemReparacaoDetalheES" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%--<div id="content">
        <div class="page-header">
            <div class="pull-left">
                <h4><i class="icon-file-alt"></i>Ordens de Reparação | Detalhe</h4>
            </div>
            <div class="pull-right">
                <ul class="bread">
                    <li><a href="Default.aspx">Home</a><span class="divider">/</span></li>
                    <li><a href="FecharOrdemReparacao.aspx">Ordens de Reparação</a><span class="divider">/</span></li>
                ...
                <div class="span12">
                    <div class="box">
                        <div class="box-head">
                            ...
                            <span>Ordem de Reparação</span>
                        </div>
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">

                                <div class="control-group">
                                    <label for="textfield" class="control-label">Código de Ordem de Reparação</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" Font-Bold="true" ForeColor="Green" ID="tbcodordemreparacao" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Data de Registo</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbdataRegisto" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Valor Final</label>
                                    <div class="controls">
                                        <telerik:RadNumericTextBox Culture="pt-PT" Enabled="false" Width="285" Type="Currency" runat="server" ID="tbvalorfinal" ForeColor="Red" CssClass="input-xlarge" Skin="MetroTouch"></telerik:RadNumericTextBox>
                                    </div>
                                </div>
                                  
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Valor Adicional</label>
                                    <div class="controls">
                                        <telerik:RadNumericTextBox Culture="pt-PT" Width="285" Type="Currency" runat="server" ID="tbvaloradicional" ForeColor="Red" CssClass="input-xlarge" Skin="MetroTouch"></telerik:RadNumericTextBox>
                                    </div>
                                </div>

                                <div class="form-actions">
                                    <asp:Button runat="server" ID="btnGravar" Text="Fechar" CssClass="button button-basic-blue" OnClick="btnGravar_Click" />
                                    <asp:Button runat="server" ID="btnVoltar" Text="Voltar" CssClass="button button-basic" OnClick="btnVoltar_Click" />
                                </div>
                            </div>
                        ...
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ReadOnly="true" Font-Bold="true" ForeColor="Green" AutoPostBack="true" runat="server" ID="tbcodcliente" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Nome de Cliente</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbnome" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Morada de Cliente</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbmorada" ReadOnly="true" TextMode="MultiLine" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Código Postal de Cliente</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbcodpostal" ReadOnly="true" MaxLength="8" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Localidade de Cliente</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tblocalidade" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Contacto de Cliente</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbcontacto" ReadOnly="true" MaxLength="9" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Email de Cliente</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbemail" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">NIF de Cliente</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbnif" ReadOnly="true" MaxLength="9" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Observações</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbobs" ReadOnly="true" TextMode="MultiLine" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Cliente desde</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbdataRegistocliente" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-head">
                            <i class="icon-list-ul"></i>
                            <span>Equipamento Avariado</span>
                        </div>
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbmarca" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Modelo</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbmodelo" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">IMEI</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbimei" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                 <div class="control-group">
                                    <label for="textfield" class="control-label">Novo IMEI</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbnovoimei" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Código de Segurança</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbcodseguranca" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Descrição Detalhada do Problema</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbdescricaoProblemaEquipAvariado" ReadOnly="true" TextMode="MultiLine" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Tipo de Reparação</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbtiming" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Data Prevista de Conclusão da Reparação</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbdataprevistareparacao" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-head">
                            <i class="icon-list-ul"></i>
                            <span>Trabalhos Adicionais a Realizar</span>
                        </div>
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Reset Software</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbresetsoftware" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Actualização de Software</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbactualizacaosoft" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Reparação Hardware</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbhardware" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                   ...
                                   <div class="control-group">
                                    <label for="textfield" class="control-label">Limpeza geral ao Equipamento</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbLimpeza" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Backup Info</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbbackupinfo" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Observações</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ReadOnly="true" ID="tbObsTrabalhosRealizar" CssClass="input-xlarge" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box">
                        <div class="box-head">
                            <i class="icon-list-ul"></i>
                            <span>Estado do Equipamento Avariado</span>
                        </div>
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Equipamento Bloqueado à Operadora</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbbloqueiooperadora" Enabled="false" AutoPostBack="true" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tboperadora" ReadOnly="true" CssClass="input-xlarge"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Observações</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbobsEstadoEquipamento" ReadOnly="true" CssClass="input-xlarge" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="span12">
                    <div class="box">
                        ...
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Bateria</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbbateriaequipavariado" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Carregador</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbcarregadorequipavariado" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Cartão SIM</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbcartaosimequipavariado" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Bolsa de Transp.</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbbolsaequipavariado" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Cartão de Memória</label>
                                    <div class="controls">
                                        <telerik:RadButton ID="rbcartaomemoriaequipavariado" Enabled="false" AutoPostBack="false" runat="server" ToggleType="CheckBox" Skin="MetroTouch" ButtonType="LinkButton">
                                            <ToggleStates>
                                                <telerik:RadButtonToggleState Text="Sim" PrimaryIconCssClass="rbToggleCheckboxChecked" />
                                                <telerik:RadButtonToggleState Text="Não" PrimaryIconCssClass="rbToggleCheckbox" />
                                            </ToggleStates>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Outros</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tboutrosequipavariado" ReadOnly="true" CssClass="input-xlarge" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Observações</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbobsequipavariado" ReadOnly="true" CssClass="input-xlarge" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="span12">
                    <div class="box">
                        ...
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Tipo de Garantia</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbtipoGarantia" CssClass="input-xlarge" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Observações</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbobsGarantiaequipavariado" CssClass="input-xlarge" ReadOnly="true" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <telerik:RadGrid Culture="pt-PT" OnNeedDataSource="listagemartigosutilizados_NeedDataSource" runat="server" Skin="MetroTouch" ID="listagemartigosutilizados" AllowPaging="True" AllowSorting="True" CellSpacing="0" GridLines="None" AllowFilteringByColumn="True">
                                                ...
                                                <MasterTableView NoMasterRecordsText="Não existem artigos registados!" NoDetailRecordsText="Não existem artigos registados!" AutoGenerateColumns="False">
                                                    <Columns>
                                                        ...
                                                        <telerik:GridBoundColumn AllowFiltering="true" ShowFilterIcon="false" DataField="VALOR_ARTIGO" DataFormatString="{0:F2} &#8364;" ReadOnly="True" HeaderText="Valor" SortExpression="VALOR_ARTIGO" UniqueName="VALOR_ARTIGO" DataType="System.Double" FilterControlAltText="Filter VALOR_ARTIGO column"></telerik:GridBoundColumn>
                                                    </Columns>
                            ...
                            <div class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                                        <ContentTemplate>
                                            <telerik:RadGrid Culture="pt-PT" OnNeedDataSource="listagemMO_NeedDataSource" runat="server" Skin="MetroTouch" ID="listagemMO" AllowPaging="True" AllowSorting="True" CellSpacing="0" GridLines="None" AllowFilteringByColumn="True">
                                                <ClientSettings>
                                                    <Scrolling AllowScroll="True" UseStaticHeaders="True"></Scrolling>
                                                </ClientSettings>
                                                <GroupingSettings CaseSensitive="false" />
                ...
                <div class="span12">
                    <div class="box">
                        ...
                        <div class="box-body box-body-nopadding">
                            <div class="form-horizontal">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Estado Actual da Reparação</label>
                                    <div class="controls">
                                        <asp:TextBox runat="server" ID="tbEstadoActualReparacao" CssClass="input-xlarge" ReadOnly="true" ForeColor="Green"></asp:TextBox>
                                    </div>
                                </div>
    ...
    <div class="container-fluid">
        ...
        <div class="control-group">
                                <label class="control-label" for="normal">Valor Final da Ordem de Reparação</label>
                                <div class="controls controls-row">
                                    <telerik:RadNumericTextBox Culture="pt-PT" Width="285" Type="Currency" runat="server" ID="tbvalorfinal" ReadOnly="true" ForeColor="Red" CssClass="input-xlarge" Skin="MetroTouch"></telerik:RadNumericTextBox>
                                </div>
                            </div>
        <div class="control-group">
                                <label class="control-label" for="normal">Valor Adicional da Ordem de Reparação</label>
                                <div class="controls controls-row">
                                    <telerik:RadNumericTextBox Culture="pt-PT" Width="285" Type="Currency" runat="server" ID="tbvaloradicional" ForeColor="Red" CssClass="input-xlarge" Skin="MetroTouch"></telerik:RadNumericTextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <asp:Button runat="server" ID="btnGravar" Text="Fechar" CssClass="btn btn-primary btn-large" OnClick="btnGravar_Click" />
            ...
            <div class="span6">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label" for="normal">Código do Equipamento de Substituição</label>
                                <div class="controls controls-row">

                                    <telerik:RadTextBox Width="285" Skin="MetroTouch" runat="server" ID="tbcodequipsubst" CssClass="span12" ReadOnly="true" ForeColor="Green"></telerik:RadTextBox>
                                </div>
                            </div>
                    ...
                    <div class="widget-content">
                        <div class="form-horizontal">
                            <div class="form-horizontal">
                                ...
                                <div class="form-actions">
                                    <asp:Button runat="server" ID="btnGravar2" Text="Fechar" CssClass="btn btn-primary btn-large" OnClick="btnGravar_Click" />
                                    <asp:Button runat="server" ID="btnVoltar2" Text="Limpar" CssClass="btn btn-inverse btn-large" OnClick="btnVoltar_Click" />
